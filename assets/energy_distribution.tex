\begin{tikzpicture}
	\begin{axis}[%
		...
		\draw[latex-latex] (0,0.05) -- (12.78,0.05) node[below,midway]{$\mathcal{R}(\mathcal{H}_1)$};
		\draw[latex-latex] (12.78,0.05) -- (20.28,0.05) node[below,midway]{$\mathcal{R}(\mathcal{H}_2)$};
		\draw[latex-latex] (20.28,0.05) -- (29.62,0.05) node[below,midway]{$\mathcal{R}(\mathcal{H}_3)$};
		\draw[latex-latex] (29.62,0.05) -- (70,0.05) node[below,midway]{$\mathcal{R}(\mathcal{H}_4)$};
	\end{axis}
\end{tikzpicture}
