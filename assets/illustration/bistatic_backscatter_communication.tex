\begin{tikzpicture}[font=\LARGE,every node/.style={draw,ultra thick},every path/.style={ultra thick},every text node part/.style={align=center}]
	...
	\node[draw=none] at (5,3.35) {Scattering\\Node};
	\node[draw=none] at (8,-1.95) {Backscatter\\Reader};

	\draw[decorate,decoration={snake,post length=2.5mm},-latex] (1,-1) -- (7.5,-1);
	\draw[decorate,decoration={snake,post length=2.5mm},-latex] (0.5,0) -- (4,2);
	\draw[decorate,decoration={snake,pre length=7.5mm,post length=7.5mm},-latex] (6,2) -- (8,0.35);
