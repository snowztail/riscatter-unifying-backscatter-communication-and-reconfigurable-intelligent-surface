...
\begin{section}{RIScatter}
	...
	\begin{figure}[!t]
		...
		\caption{
			...
			``PB'', ``BB'', and ``CB'' means primary block, backscatter block, and channel block, respectively.
			\gls{bc} employs all possible states only as information codewords, \gls{ris} treats them only as beamformer codewords, and RIScatter simultaneously exploits both benefits.
		}
