...
\begin{section}{Rate-Region Characterization}
	...
	\begin{subsection}{Active Beamforming}
		...
		\begin{align}
			I(x_{\mathcal{K}})
			 & =\sum_{m_{\mathcal{K}}}P_{\mathcal{K}}(x_{m_{\mathcal{K}}})\Biggl(\rho\log\Bigl(1+\frac{\lvert\boldsymbol{h}^\mathsf{H}(x_{m_{\mathcal{K}}})\boldsymbol{w}\rvert^2}{\sigma_v^2}\Bigr) \nonumber                                                                                                                                                                                                                 \\
