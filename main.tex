...
\begin{section}{Scattering Principles}
	...
	% In this section, we first introduce the principles of two common scatterer categories, then briefly
...
\begin{section}{UniScatter}
	We introduce UniScatter as a novel low-power communication/assistance protocol that generalizes \gls{bc}, \gls{sr} and \gls{ris} using shared spectrum, energy and infrastructures.
	% In particular, the passive UniScatter nodes ride over an active legacy transmission to simultaneously encode self information and reconfigure wireless environment.
	% Using shared spectrum, energy and infrastructures, the passive UniScatter nodes ride over an active legacy transmission for backscatter modulation and passive beamforming, while the low-complexity cooperative UniScatter receiver decodes both links
	% In particular, the passive UniScatter nodes adapt input distribution based on link priority and \gls{csi}
	In particular, the passive UniScatter nodes ride over an active legacy transmission in a flexible and mutualistic manner, while the practical cooperative UniScatter receiver decodes both links under the benefits of backscatter modulation and passive beamforming.
