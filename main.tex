...
\begin{section}{RIScatter}
	\begin{subsection}{Principles}
		...
		\begin{itemize}
			...
			The reflection coefficient at state $m$ is used merely an information codeword \cite{Thomas2012a}
			\begin{equation}
			...
			The reflection coefficient at state $m$ is used merely a passive beamforming codeword \cite{Wu2018}
			\begin{equation}
		...
		Each reflection coefficient is simultaneously an information codeword and a passive beamforming codeword.
		As shown in Fig.~\ref{fg:scatter_comparison}, RIScatter nodes semi-randomly choose reflection states according to an input distribution that strikes a balance between backscatter modulation and passive beamforming.
		\begin{figure}[!t]
			\centering
	...
	\begin{subsection}{System Model}
		...
		In the backscatter multiple access system, the \gls{ap} acts as carrier emitter, the RIScatter nodes modulate over scattered signal, and the user jointly decodes all node messages.\footnote{It is assumed that the signal going through two or more RIScatter nodes is too weak to be received by the user.}
		...
		% It is assumed that the signal going through two or more RIScatter nodes is too weak to be received by the user, the primary symbol duration is much longer than multipath delay spread (no inter-symbol interference), and the spreading factor $N$ is a positive integer.
