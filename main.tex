	...
	\begin{section}{Input Distribution, Decision Region, and Precoder Design}
		...
		\begin{subsection}{Input probability distribution}
			...
			\begin{theorem}
				...
				\end{equation}
				where $r \in \mathbb{Z}_+$ is the iteration index and $P_k^{(0)}(\bar{c}_{m_k}) > 0$, $\forall m_k \in \mathcal{M}$ and $\forall k \in \mathcal{K}$.
