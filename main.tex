...
\begin{section}{Scattering Principles}
	...
	\begin{subsection}{Scatterer Categories}
		...
		\begin{subsubsection}{Antenna-Based Scatterer}
			...
			% To support the operation of on-chip components, the majority of incident wave is consumed for energy harvesting
			...
			% Antenna-based scatterers are typically considered in \gls{bc} and \gls{sr} literatures, while some \gls{ris}
			% BC and SR typically antenna-based, RIS both
		\end{subsubsection}
