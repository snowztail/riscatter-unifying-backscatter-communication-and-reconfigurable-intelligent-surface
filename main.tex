...
\begin{section}{Introduction}
	...
	Motivated by those, we propose the concept of Metascatter that adapts the input distribution of a passive backscatter node to generalize backscatter sources of \gls{sr} and reflecting elements of \gls{irs}.
