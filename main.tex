...
\begin{section}{Introduction}
	...
	\begin{subsection}{Related Works}
		...
		Those \gls{ris}-empowered \gls{bc} designs can recycle electromagnetic wave on the air to simultaneously boost wireless channels and establish new connections, but incurs advanced hardware architecture and high optimization complexity.
	...
	\begin{subsection}{Contributions}
		...
		\emph{First,} we propose RIScatter that unifies \gls{bc} and \gls{ris} and leverages their benefits from an input distribution perspective.
		The concept is presented in Fig. \subref*{fg:riscatter}.
		In part

		multiple dispersed or co-located passive scatter nodes whose
