...
\begin{section}{Introduction}
	...
	Each reflection state simultaneously acts as information codeword and passive beamforming codeword.
	The reflection pattern of each node is randomly chosen with the guidance of reflection state distribution, which is designed as a joint function of the information source, \gls{csi}, and \gls{qos}.
	...
	\emph{Second,} we address the first challenge and propose a practical receiver that accommodates the properties of active-passive coexisting networks.
	It semi-coherently decodes the backscatter information by energy detection, recovers the exact reflection pattern, and coherently decodes the primary link.
	% Double modulation enables symbol-level passive precoding such that the
	Once successfully decoded, the multiplicative backscatter interference can be modelled as dynamic passive beamforming (rather than being re-precoded and cancelled), and thus the energy detection becomes part of channel training.
	...
	This is the first paper to consider practical backscatter-primary decoding and treat semi-coherent backscatter detection as part of primary channel training.
