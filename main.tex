...
\begin{section}{Introduction}
	...
	\begin{subsection}{Contributions}
		...
		\emph{Second,} we propose a practical receiver that accommodates the double modulation and signal difference in scatter-based cooperative networks.
