...
\begin{section}{Introduction}
	\begin{subsection}{Fundamentals}
		...
		The backscatter reader can be either co-located or separated with the carrier emitter, known as monostatic and bistatic \gls{bc} in Fig. \subref*{fi:monostatic_backscatter_communication} and \subref*{fi:bistatic_backscatter_communication}, respectively.
