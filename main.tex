...
\begin{section}{Simulation Results}
	...
	We assume the distance between \gls{ap} and user is \SI{10}{\meter}, and $K=2$ Metascatters are uniformly dropped within a disk centered at the user of radius \SI{1}{\meter}.
	...
	\begin{subsection}{Input Distribution vs. Weight}
		...
		In this case, Metascatter boils down to an \gls{irs} element with $M$ discrete states.
	...
	\begin{subsection}{Rate Region vs. System Configuration}
		...
		\begin{figure}[!t]
			\centering
			\subfloat[User Coverage\label{fi:region_coverage}]{
				\resizebox{0.48\columnwidth}{!}{
