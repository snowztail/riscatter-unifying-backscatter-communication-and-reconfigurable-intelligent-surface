...
\begin{section}{RIScatter}
	...
	\begin{subsection}{Achievable Rates}
		...
		% Denote the input probability of node $k$ at state $m_k$ as $P_k(x_{m_k})$, and the input distribution vector as $\boldsymbol{p}_k \triangleq [P_k(c_1),\ldots,P_k(c_M)]^\mathsf{T} \in \mathbb{I}^{M}$.
