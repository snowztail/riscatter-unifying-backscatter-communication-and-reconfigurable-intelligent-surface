...
\begin{section}{Introduction}
	...
	\begin{subsection}{Contributions}
		...
		% We first express the achievable primary and total backscatter rates under given \gls{qos} as functions of active beamforming at the \gls{ap}, input distribution at RIScatter nodes, and backscatter decision regions at the user.
		...
		% The proposed backscatter input distribution design can also be generalized to other setups.
...
\begin{section}{Simulation Results}
	...
	\begin{subsection}{Comparison of Scattering Applications}
		...
		For \gls{sr} with \gls{sic} and \gls{mrc}, the effective backscatter \gls{snr} is increased by $N$ times and the penalty term $\iota$ becomes insignificant.
