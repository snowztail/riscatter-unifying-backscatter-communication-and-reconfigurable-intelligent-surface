...
\begin{section}{Scattering Principles}
	...
	\end{figure*}
	% The introduction of an obstacle in the path of a plane electromagnetic wave produces scattering.
	Scattering is defined as a change of moving direction of particles after colliding with others.
	% It often refers to the diffuse reflection where the incident particles are redistributed at many angles rather than the opposite direction.
	...
	% In \gls{rf} applications such as \gls{bc}, \gls{sr} and \gls{ris}, the scatterer often includes integrated antenna or programmable metamaterial for controllable reflection pattern \cite{Liang2022}.
	% In \gls{rf} applications such as \gls{bc}, \gls{sr} and \gls{ris}, the scatterer often includes integrated antenna or programmable metamaterial for the diversity of reflection patterns \cite{Liang2022}.
	In \gls{rf} applications such as \gls{bc}, \gls{sr} and \gls{ris}, the scatterer often includes variable-load antenna or programmable metamaterial for various reflection patterns \cite{Liang2022}.
	% For the former case, the signal impinging on the antenna is first received,
	% For the former case, the antenna first receives the impinging signal, then reradiates a part and absorb the rest.
	The antenna-based scatterer first receive the impinging signals, then reradiate a portion back to the space and absorb the remainder potentially for energy harvesting.
	% According to \cite{Hansen1989}, the reradiated part can be decomposed into \emph{structural} component that consistently contributes to environment multipath and \emph{antenna} component that depends on antenna-load impedance mismatch.
	...
	On the other hand, ideal metamaterial-based scatterers reflect the incident waves without receiving them, and the reflection happens at the interface between free space and metamaterial.
	% The reflection happens at the interface between free space and metamaterial, and the reflection coefficient at metamaterial unit is
	% The reflection happens at the interface between free space and metamaterial.
	...
	\end{equation}
	where $Z_0 = \qty{377}{\ohm}$ is the characteristic impedance of free space.
	...
	signal impinging on the antenna is first received,


	Diffuse reflection is the reflection of light or other waves or particles from a surface such that a ray incident on the surface is scattered at many angles rather than at just one angle as in the case of specular reflection.

	% By definition, reflection
	% Scattering refers to a diffuse reflection
	scattering, in physics, a change in the direction of motion of a particle because of a collision with another particle.
	Scattering thus refers to particle-particle collisions between molecules, atoms, electrons, photons and other particles.
