...
\begin{section}{Scattering Principles}
	...
	\begin{subsection}{RIS: Channel Reconfiguration}
		...
		% By \emph{adaptively deciding} the reflection pattern, each reflecting element alters the phase of reflected signal for constructive/destructive superposition at the receiver.
