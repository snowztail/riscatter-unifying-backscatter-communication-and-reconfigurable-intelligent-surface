...
\begin{section}{Simulation Results}
	...
	\begin{subsection}{Evaluation of Proposed Algorithms}
		...
		\begin{subsubsection}{Convergence}
			...
			\end{figure}
			The \gls{bcd} algorithm is convergent for the optimization problem \eqref{op:weighted_sum_rate}, since the input distribution and active beamforming subproblems converge and the thresholding subproblem attains global optimality.
