	...
	\begin{subsection}{Rate Region under Different Schemes}
		...
		\begin{subsubsection}{Input Distribution}
			...
			\begin{itemize}
				...
				% \item \emph{\gls{kkt}:} Numerical evaluation of the \gls{kkt} solutions by Algorithm \ref{al:input_distribution};
		...
		\begin{subsubsection}{Active Beamforming}
			...
			Fig. \subref*{fi:region_beamforming} reveals the achievable regions for those active beamforming schemes.
