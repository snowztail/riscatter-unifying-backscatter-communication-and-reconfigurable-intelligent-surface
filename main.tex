...
\begin{abstract}
	...
	For simplicity, the user is assumed first decodes all Metascatters jointly by energy detection, then models their contribution within equivalent channel and decodes primary link.
	...
	Simulation results demonstrate Metascatters can exploit additional backscatter paths to transmit and assist.
	% the \gls{kkt} input distribution is
	...
	% the user employ joint energy detection on all tags, then model their reflection pattern within the equivalent CSI for primary decoding.
