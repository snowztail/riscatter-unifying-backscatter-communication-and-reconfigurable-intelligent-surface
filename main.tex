...
\begin{section}{Simulation Results}
	...
	\begin{subsection}{Rate Region under Different Configurations}
		...
		\begin{subsubsection}{Imperfect \gls{csi}}
			...
			On the other hand, a small estimation error may be insufficient to change the optimal passive beamforming state (especially for a small $M$) and the primary rate is almost unchanged here.
		\end{subsubsection}
	\end{subsection}
\end{section}
