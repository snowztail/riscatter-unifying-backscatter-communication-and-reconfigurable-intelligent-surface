...
\begin{section}{UniScatter}
	...
	% Using shared spectrum, energy and infrastructures, UniScatter is a novel passive communication/assistance protocol that generalizes \gls{bc}, \gls{sr} and \gls{ris} via \emph{physical} and \emph{probability} distributions.
