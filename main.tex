...
\begin{section}{Backscatter Principles}
	...
	% The scatter model is illustrated in Fig. \subref*{fi:scatter_model}.
	Fig. \subref*{fi:scatter_model} illustrates the scatter model of a node with $M$ candidate states, and the reflection coefficient of state $m \in \mathcal{M} \triangleq \{1,\ldots,M\}$ is defined as%
