...
\begin{section}{RIScatter}
	\begin{subsection}{Principles}
		...
		The detail will be covered in the next section.
	\end{subsection}
	...
	% Hence, the receiver can semi-coherently (under primary uncertainty) decode RIScatter nodes from the accumulated receive energy, re-encode to recover the reflection patterns, and combine those with cascaded \gls{csi} to determine the multipath response and model within the primary channel.
