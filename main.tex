	...
	\begin{section}{Input Distribution, Decision Region, and Precoder Design}
		...
		\begin{subsection}{Input probability distribution}
			...
			\begin{proof}
				...
				% Let $P_{\mathcal{K}}(\bar{c}_{m_{\mathcal{K}}}) = \prod_{k \in \mathcal{K}} P_k(\bar{c}_{m_k})$ and $P_{\mathcal{K}}'(\bar{c}_{m_{\mathcal{K}}}) = P_q'(\bar{c}_{m_q}) \prod_{k \in \mathcal{K} \setminus \{q\}} P_k(\bar{c}_{m_k})$ be two probability distributions associated with input combination $\bar{c}_{m_{\mathcal{K}}}$
			\end{proof}
