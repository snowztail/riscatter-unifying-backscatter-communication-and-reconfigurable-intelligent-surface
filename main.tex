...
\begin{document}
	...
	\begin{section}{The Multi-Tag Case}
		...
		\begin{subsection}{Backscatter sum-capacity}
			...
			% On top of them, the mutual information and marginal mutual information can be written respectively as\footnote{Please be aware that $c_{\mathcal{K}}$, $c_{\mathcal{S}}$, $z$ are random variables, while $\bar{c}_{m_{\mathcal{K}}}$ (and $\bar{c}_i$), $\bar{c}_{m_{\mathcal{S}}}$, $\bar{z}_j$ represent the corresponding instances.}
			% \begin{align}
			% 	I(c_{\mathcal{K}} ; z)
			...
			% On top of \eqref{eq:information_function} and \eqref{eq:marginal_information_function}, the mutual information can be expressed as\footnote{Please be aware that $c_{\mathcal{K}}$, $c_{\mathcal{S}}$, $z$ are random variables, while $\bar{c}_{m_{\mathcal{K}}}$ (and $\bar{c}_i$), $\bar{c}_{m_{\mathcal{S}}}$, $\bar{z}_j$ represent the corresponding instances.}
			% \begin{equation}
			% 	I(c_{\mathcal{K}} ; z) = \mathbb{E}_{c_{\mathcal{K}}} \left[I(\bar{c}_{m_{\mathcal{K}}} ; z)\right] = \mathbb{E}_{c_{\mathcal{S}}} \left[I_{\mathcal{S}}(\bar{c}_{m_{\mathcal{S}}} ; z)\right].
			% \end{equation}
