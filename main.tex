...
% \newacronym{emrt}{EMRT}{ergodic \gls{mrt}}
...
\begin{section}{Rate-Region Characterization}
	...
	\begin{subsection}{Decision Threshold}
		...
		\begin{maxi!}
			{\scriptstyle{\boldsymbol{t} \in \mathcal{T}^{L+1}}}{I(x_{\mathcal{K}})}{\label{op:decision_threshold_discrete}}{\label{ob:decision_threshold_discrete}}
...
\begin{section}{Simulation Results}
	...
	\begin{subsection}{Backscatter Rate versus Energy Discretization Bits}
		\begin{figure}[!t]
			\subfloat[Instance 1\label{fi:rate_bits_primary}]{
				\resizebox{0.48\columnwidth}{!}{
					\input{assets/simulation/rate_bits_primary.tex}
				}
			}
			\subfloat[Instance 2\label{fi:rate_bits_backscatter}]{
				\resizebox{0.48\columnwidth}{!}{
					\input{assets/simulation/rate_bits_backscatter.tex}
				}
			}
			\caption{Average achievable primary and total backscatter rates for different energy discretization bits.}
			\label{fi:rate_bits}
		\end{figure}
		...
		% TODO Total Backscatter Rate versus Output Discretization Bit
		TODO
	...
	\begin{subsection}{Rate Region by Different Schemes}
		...
		\end{figure}
		The impacts of different input distribution, active beamforming, and decision threshold schemes on the average primary-backscatter rate region are explored in this study.
		...
		\begin{subsubsection}{Input Distribution}
			...
			% Those observations demonstrate the performance and complexity advantages of the proposed \gls{kkt} input distribution design, and reveal the potential of joint encoding at UniScatter nodes.
	...
	\begin{subsection}{Rate Region versus Configuration}
		\begin{figure}[!t]
			\centering
			\subfloat[Nodes\label{fi:region_tags}]{
				\resizebox{0.48\columnwidth}{!}{
			...
			\subfloat[Coverage Radius\label{fi:region_coverage}]{
				\resizebox{0.48\columnwidth}{!}{
