...
\begin{abstract}
	...
	\gls{ris} adapts scattering antennas or programmable metamaterial to control propagation environment by boosting/suppressing signal strength in specific directions.
...
\begin{section}{Introduction}
	...
	The authors concluded if this ratio is sufficiently long, the non-coherent primary rate would asymptotically approach its coherent counterpart.
	...
	However, the advantage of \gls{sic} is questionable because 1) backscatter pattern and signal characteristics are not fully exploited; 2) non-coherent primary encoding is required at the transmitter while re-encoding, precoding, and subtraction are required at the receiver; 3) primary and backscatter symbols are mixed by multiplication instead of superposition.
	...
	\cite{Xu2021a} proposed a backscatter \gls{noma}-based \gls{sr} by extending the \gls{sic} scheme to multi-node scenario, where the decoding order depends on backscatter signal strength.
