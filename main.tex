...
\begin{abstract}
	...
	% Scattering/reflection elements to
	% An RIS is a thin surface composed of N elements, each being a reconfigurable scatterer: a small antenna that receives and re-radiates without amplification, but with a configurable time delay [3]. For narrowband signals, this delay corresponds to a phase shift.

	Scatterers can harvest energy from, modulate information over, and reconfigure propagation of ambient radio waves.
	In backscatter communication,
	% ! Φ(c[n]) vs P

	% TODO
	back comms, symbiotic radio and RIS have appeared as three different and somewhat unrelated wireless technologies, explaining the key feature of each of them. Then I would say we introduce metascatter as a new paradigm that unifies and generalizes those three ...., explain the key feature of metascatter.
