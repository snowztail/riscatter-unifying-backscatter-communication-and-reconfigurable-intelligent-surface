			...
			\begin{block}{RIScatter system}
				\begin{figure}[!t]
					...
					\resizebox{0.5\linewidth}{!}{
						\input{../assets/poster/riscatter.tex}
					}
					\label{fg:riscatter}
				\end{figure}
				\begin{itemize}\setlength\itemsep{20pt}
				...
				\begin{figure}[!t]
					...
					\subfloat[Block Diagram]{
						\resizebox{0.53\linewidth}{!}{
							\input{../assets/poster/block_diagram.tex}
						}
						\label{fg:block_diagram}
					}
					\subfloat[Scatter Model]{
						\resizebox{0.42\linewidth}{!}{
							\input{../assets/poster/scatter_model.tex}
						}
				...
				\begin{column}{\colwidth}
					\begin{block}{Low-complexity receiver}
						\begin{figure}[!t]
							...
							\subfloat{
								\resizebox{0.42\linewidth}{!}{
									\input{../assets/poster/receiver.tex}
								}
							}
							\hspace{-1.5cm}
							\subfloat{
								\resizebox{0.58\linewidth}{!}{
									\input{../assets/poster/energy_distribution.tex}
								}
							}
							\label{fg:receiver}
						\end{figure}
					...
					\begin{thm}{Decision threshold}{}
						\begin{figure}[!t]
							...
							\resizebox{0.65\linewidth}{!}{
								\input{../assets/poster/discrete_outputs.tex}
							}
						\end{figure}
				...
				\begin{column}{\colwidth}
						...
						\begin{figure}[!t]
							...
							\subfloat{
								\resizebox{0.48\linewidth}{!}{
									\input{../assets/poster/input_distribution.tex}
								}
							}
							\subfloat{
								\resizebox{0.48\linewidth}{!}{
									\input{../assets/poster/distribution_weights.tex}
								}
							}
						\end{figure}
					...
					\begin{exampleblock}{Rate region}
						\begin{figure}[!t]
							...
							\subfloat{
								\resizebox{0.48\linewidth}{!}{
									\input{../assets/poster/region_comparison.tex}
								}
							}
							\subfloat{
								\resizebox{0.48\linewidth}{!}{
									\input{../assets/poster/region_duration.tex}
								}
							}
						\end{figure}
