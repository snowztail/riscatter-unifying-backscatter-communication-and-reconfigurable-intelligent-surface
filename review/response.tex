...
\begin{reviewer}
	...
	\reply {Thank you for the suggestion and we understand it can be very difficult for readers to keep track of all acronyms and notations throughout the paper. We tried to add a list of acronyms and notations, but it would violate the 30-page limit and we cannot squeeze enough space from other places. Therefore, we decided not to include the list. We have ensured that all acronyms are defined before their first usage.}
	...
	\point The link between eq. (9) and eq. (25) lacks clarity and misses intermediate steps. Also, the expression of the function Q provided in eq. (25) appears to be independent of the active beamforming `w'.  It is unclear how the derivation of Q with respect to 'w' is performed in this case. Please clarify the relationship between Q and 'w' and provide a clear derivation for better understanding. The same remark about clarity applies to eq. (28) and eq. (33).
