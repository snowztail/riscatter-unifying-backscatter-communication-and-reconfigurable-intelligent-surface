...
\begin{reviewer}
	...
	\reply {The BCD algorithm is convergent for the optimization problem (20), since the input distribution and active beamforming subproblems converge and the thresholding subproblem attains global optimality. This argument has been added prior to the convergence results in Fig.~\subref*{m-fg:wsr_convergence}.}
