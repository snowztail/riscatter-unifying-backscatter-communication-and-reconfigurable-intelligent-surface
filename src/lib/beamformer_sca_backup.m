function [beamformer, dmtc, weightedSumRate] = beamformer_sca_backup(weight, symbolRatio, equivalentChannel, transmitPower, noisePower, equivalentDistribution, threshold, tolerance)
	% Function:
