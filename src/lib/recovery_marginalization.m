function [inputDistribution, equivalentDistribution, weightedSumRate] = recovery_marginalization(weight, symbolRatio, equivalentChannel, noisePower, jointDistribution, precoder, dmtc)
	% Function:
