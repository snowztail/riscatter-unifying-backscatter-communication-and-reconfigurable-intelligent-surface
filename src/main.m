...
for iWeight = 1 : nWeights
	...
	[rate, inputDistribution, threshold, precoder] = block_coordinate_descent(weight, nTags, symbolRatio, equivalentChannel, txPower, noisePower, nBins, tolerance, 'Input', 'kkt', 'Threshold', 'smawk');
end
