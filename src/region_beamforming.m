...
for iVariable = 1 : nVariables
	...
	for iWeight = 1 : nWeights
		...
		[rate, distribution, threshold, beamforming] = block_coordinate_descent(nTags, symbolRatio, transmitPower, noisePower, nBins, weight, equivalentChannel, 'Distribution', 'kkt', 'Beamforming', Variable(iVariable).Beamforming, 'Threshold', 'smawk');
