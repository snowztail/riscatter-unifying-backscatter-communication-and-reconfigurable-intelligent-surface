...
% * Evaluate rate region for different input distribution design
for iVariable = 1 : nVariables
	...
	for iWeight = 1 : nWeights
		...
		[rate, distribution, threshold, beamforming] = block_coordinate_descent(nTags, symbolRatio, transmitPower, noisePower, weight, equivalentChannel, 'Distribution', Variable(iVariable).Distribution, 'Beamforming', 'pgd', 'Threshold', 'smawk', 'Recovery', Variable(iVariable).Recovery);
